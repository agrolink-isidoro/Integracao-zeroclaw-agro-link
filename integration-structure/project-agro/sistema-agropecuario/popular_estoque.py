#!/usr/bin/env python3
"""
Script para popular o estoque com produtos relacionados aos locais de armazenamento
"""
...
from backend.apps.estoque.models import LocalArmazenamento, Produto, Lote, Movimentacao
...
produtos_existentes = Produto.objects.count()
if produtos_existentes > 0:
    print(f'\n⚠ Existem {produtos_existentes} produtos no sistema')
    print('Mantendo produtos existentes e adicionando novos...')
...
print(f'📋 Total de movimentações: {Movimentacao.objects.count()}')
