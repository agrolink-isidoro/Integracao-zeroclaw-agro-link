...
ACTION_FIELDS_SCHEMA = {
    ...
    # ALIAS: registrar_operacao_agricola é equivalente a operacao_agricola
    "registrar_operacao_agricola": {
        "action_type": "registrar_operacao_agricola",
        "module": "agricultura",
        "model_target": "Operacao",
        "description": "Registra uma operação agrícola (pulverização, adubação, plantio, dessecação, etc.) — chamada via 'registrar_operacao_agricola' ou 'operacao_agricola'",
        "fields": {
            "required": [],
            "optional": [
                {
        ...
        "validation_notes": [
            "Se nem safra nem fazenda forem informadas, a validação do model Operacao falha",
            "A categoria é derivada automaticamente do prefixo do tipo",
            "custo_total é calculado automaticamente",
        ],
    },
