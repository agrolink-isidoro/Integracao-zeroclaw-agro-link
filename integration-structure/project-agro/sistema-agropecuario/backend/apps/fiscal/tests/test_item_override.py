...
class ItemNFeOverrideTests(TestCase):
    ...
    def test_create_override(self):
        nfe = NFe.objects.create(chave_acesso='1'*44, numero='1', serie='1', data_emissao=timezone.now(), emitente_nome='E', destinatario_nome='D', valor_produtos=0, valor_nota=0)
    ...
    def test_confirmar_estoque_uses_override(self):
        ...
        nfe = NFe.objects.create(chave_acesso='2'*44, numero='1', serie='1', data_emissao=timezone.now(), emitente_nome='E', destinatario_nome='D', valor_produtos=0, valor_nota=0)
