 ...
 */
function diasPorPeriodicidade(periodicidade: string): number {
 ...
 */
export function calcularDataVencimento(dataInicio: string, diasAdicionar: number): string {
 ...
 */
export function gerarParcelas(params: GerarParcelasParams): ParcelaVenda[] {
 ...
 */
export function calcularPrazoExecucao(dataInicio: string, dataFim: string): number {
 ...
 */
export function formatarParcelasPadraoExibicao(parcelas: ParcelaVenda[]): ParcelaVenda[] {
