...
describe('EmprestimosList', () => {
  it('renders list and exports CSV when clicking Exportar CSV and calls gerarParcelasEmprestimo', async () => {
    const sample: Emprestimo[] = [{ id: 2, descricao: 'Emp 1', valor_emprestado: 500, numero_parcelas: 6, data_contratacao: '2026-02-01', criado_em: '2026-02-01' } as any];
    ...
    renderWithClient(<EmprestimosList />);
  ...
  it('opens inline create form and submits', async () => {
    ...
    mocked.createEmprestimo.mockResolvedValue({ id: 888 } as any);
