...
const mockedService = financeiroService;
...
describe('VencimentosCalendar', () => {
    it('renders badges and opens modal on day click', async () => {
        ...
        renderWithClient(_jsx(VencimentosCalendar, {}));
        ...
        const winMock = { document: { open: jest.fn(), write: jest.fn(), close: jest.fn() }, focus: jest.fn(), print: jest.fn() };
        ...
        mockedService.marcarVencimentoPago.mockResolvedValue({ id: 1, titulo: 'Teste 1', descricao: 'Desc 1', valor: 100.0, data_vencimento: '2026-01-10', data_pagamento: '2026-01-10', status: 'pago', tipo: 'despesa', criado_em: '2026-01-01', atualizado_em: '2026-01-01' });
