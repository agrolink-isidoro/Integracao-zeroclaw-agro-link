...
describe('EmpresasList', () => {
    it('renders list of empresas', async () => {
        service.default.getEmpresas = jest.fn().mockResolvedValue(mockEmpresas);
        const q = new QueryClient();
        render(_jsx(QueryClientProvider, { client: q, children: _jsx(MemoryRouter, { children: _jsx(EmpresasList, {}) }) }));
