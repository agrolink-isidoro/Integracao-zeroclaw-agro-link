...
describe('FornecedoresCharts', () => {
  it('renders bar and pie charts when data is provided', () => {
    ...
    render(<FornecedoresCharts topFornecedores={top} documentosVencendo={2} documentosVencidos={1} />);
  ...
  it('shows no-data message when no top fornecedores', () => {
    render(<FornecedoresCharts topFornecedores={[]} documentosVencendo={0} documentosVencidos={0} />);
