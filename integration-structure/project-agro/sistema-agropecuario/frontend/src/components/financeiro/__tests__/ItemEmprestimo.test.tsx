...
const mockedProdutosService = ProdutosService as jest.Mocked<typeof ProdutosService>;
  ...
  it('renders product selector with available products', async () => {
    ...
    render(
      <QueryClientProvider client={qc}>
        <ProductSelector onAddItem={onAddItem} />
      </QueryClientProvider>
    );
...
describe('ItemEmprestimoList Component', () => {
  const mockItems: Omit<ItemEmprestimo, 'emprestimo'>[] = [
    {
      id: 1,
      produto: 1,
