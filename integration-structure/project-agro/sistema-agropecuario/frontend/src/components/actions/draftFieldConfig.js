 ...
 */
export const DRAFT_FIELD_CONFIG = {
    // ═══ MÓDULO MÁQUINAS ═══════════════════════════════════════════════════════
    abastecimento: {
        maquina_nome: {
            label: 'Máquina',
    ...
    criar_equipamento: {
        ...
        categoria: {
            label: 'Categoria',
            select: { label: 'Categoria', source: 'categorias_eq', displayField: 'nome', valueField: 'id' },
        },
        marca: { label: 'Marca' },
        modelo: { label: 'Modelo' },
        ...
        capacidade_tanque: { label: 'Capacidade do Tanque (litros)' },
    ...
    operacao_agricola: {
        ...
        tipo_operacao: {
            ...
            select: {
                ...
                source: 'static',
                options: [
                    { value: 'prep_limpeza', label: 'Limpeza de Área' },
                    { value: 'prep_aracao', label: 'Aração' },
                    { value: 'prep_gradagem', label: 'Gradagem' },
                    { value: 'prep_subsolagem', label: 'Subsolagem' },
                    { value: 'prep_correcao', label: 'Correção do Solo' },
                    { value: 'adub_base', label: 'Adubação de Base' },
                    { value: 'adub_cobertura', label: 'Adubação de Cobertura' },
                    { value: 'adub_foliar', label: 'Adubação Foliar' },
                    { value: 'plant_dessecacao', label: 'Dessecação' },
                    { value: 'plant_direto', label: 'Plantio Direto' },
                    { value: 'plant_convencional', label: 'Plantio Convencional' },
                    { value: 'trato_irrigacao', label: 'Irrigação' },
                    { value: 'trato_poda', label: 'Poda' },
                    { value: 'trato_desbaste', label: 'Desbaste' },
                    { value: 'trato_amontoa', label: 'Amontoa' },
                    { value: 'pulv_herbicida', label: 'Aplicação de Herbicida' },
                    { value: 'pulv_fungicida', label: 'Aplicação de Fungicida' },
                    { value: 'pulv_inseticida', label: 'Aplicação de Inseticida' },
                    { value: 'pulv_pragas', label: 'Controle de Pragas' },
                    { value: 'pulv_doencas', label: 'Controle de Doenças' },
                    { value: 'pulv_daninhas', label: 'Controle de Plantas Daninhas' },
                    { value: 'mec_rocada', label: 'Roçada' },
                    { value: 'mec_cultivo', label: 'Cultivo Mecânico' },
                ],
            },
        },
        trator: {
            label: 'Trator / Equipamento',
            select: { label: 'Trator', source: 'equipamentos', displayField: 'nome', valueField: 'nome' },
        },
        implemento: {
            label: 'Implemento / Reboque',
            select: { label: 'Implemento', source: 'equipamentos', displayField: 'nome', valueField: 'nome' },
        },
        produto_insumo: {
 ...
 */
export function getRequiredSources(actionType) {
 ...
 */
export function getFieldLabel(actionType, fieldKey) {
    const config = DRAFT_FIELD_CONFIG[actionType];
    if (config?.[fieldKey]?.label)
        return config[fieldKey].label;
    // Fallback: humanize
    return fieldKey
        .replace(/_/g, ' ')
